...
const WAQI_TOKEN = "f158a46b18a39c7cd6469d9ae44ba7b6c6d11f9b";
# "ce79b4fab3208523b358a65b2eccc4ca6b84b269";
...
document.getElementById("loc0").onclick = function() {FindLocation(0); var cityName = "Location0"; openCity(cityName)};

document.getElementById("loc1").onclick = function() {FindLocation(1); var cityName = "Location1"; openCity(cityName)};

document.getElementById("loc2").onclick = function() {FindLocation(2); var cityName = "Location2"; openCity(cityName)};
